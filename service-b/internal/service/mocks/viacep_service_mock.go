...
import (
	...
	service "github.com/felipemagrassi/lab2-weather-telemetry-app/service-b/internal/service"
...
func (mr *MockCepServiceMockRecorder) GetAddressByCep(ctx, cep interface{}) *gomock.Call {
